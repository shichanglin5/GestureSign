...
namespace GestureSign.Daemon.Triggers
{
    class TriggerManager
    {
        ...
        private void Trigger_TriggerFired(object sender, TriggerFiredEventArgs e)
        {
            ...
            PluginManager.Instance.ExecuteAction(e.FiredActions, PointCapture.Instance.Mode, PointCapture.Instance.SourceDevice, new List<int>(new[] { 1 }), point, new List<List<Point>>(new[] { point }), e.Velocity);
        }
